...
add_filter( 'the_content', 'material_design_par_amauri_chat_content' );

/* Auto-add paragraphs to the chat text. */
add_filter( 'material_design_par_amauri_format_chat_text', 'wpautop' );
...
function material_design_par_amauri_chat_content( $content ) {
	...
	foreach ( $chat_rows as $chat_row ) {
		...
		if ( strpos( $chat_row, $separator ) ) {
			...
			/* Open the chat row. */
			$pair = 'chat-right';
			if ($speaker_id%2) {$pair = 'chat-left';}
 ...
 */
function material_design_par_amauri_chat_row_id( $chat_author ) {
	global $_post_format_chat_ids;
	...
	if (!in_array($chat_author, $_post_format_chat_ids)) {
